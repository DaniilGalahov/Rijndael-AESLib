...
array<array<byte, WordSize>, RconSize> Utility::BuildRcon()
{
	...
	Rcon[0] = array<byte, WordSize> {0x01, 0x00, 0x00, 0x00};
	Rcon[1] = array<byte, WordSize>{0x02, 0x00, 0x00, 0x00};
	Rcon[2] = array<byte, WordSize> {0x04, 0x00, 0x00, 0x00};
	Rcon[3] = array<byte, WordSize> {0x08, 0x00, 0x00, 0x00};
	Rcon[4] = array<byte, WordSize> {0x10, 0x00, 0x00, 0x00};
	Rcon[5] = array<byte, WordSize> {0x20, 0x00, 0x00, 0x00};
	Rcon[6] = array<byte, WordSize> {0x40, 0x00, 0x00, 0x00};
	Rcon[7] = array<byte, WordSize> {0x80, 0x00, 0x00, 0x00};
	Rcon[8] = array<byte, WordSize> {0x1b, 0x00, 0x00, 0x00};
	Rcon[9] = array<byte, WordSize> {0x36, 0x00, 0x00, 0x00};
	return Rcon;
}